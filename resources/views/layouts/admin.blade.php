    ...
    <div class="main-wrapper">
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-category">Settions</li>
                    <li class="nav-item @yield('township')">
                        <a href="{{ url('townships') }}" class="nav-link">
                            <i class="link-icon" data-feather="calendar"></i>
                            <span class="link-title">Townships</span>
                        </a>
                    </li>
                    <li class="nav-item @yield('')">
                        <a href="{{ url('hotel-facilities') }}" class="nav-link">
                            <i class="link-icon" data-feather="calendar"></i>
                            <span class="link-title">Hotel Facilities</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('students') }}" class="nav-link">
                            <i class="link-icon" data-feather="message-square"></i>
                            <span class="link-title">Room Facilities</span>
                        </a>
                    </li>
        ...
        <div class="page-wrapper">
            ...
            <nav class="navbar">
                ...
                <div class="navbar-content">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            @if (Auth::user()->dark=='0')
                                <a title="Dark Mode" href="{{ url('light',Auth::user()->id) }}" class=" nav-link">
                                    <i class="fa-solid fa-moon"></i>
                                </a>
                            @else
                                <a title="Light Mode" href="{{ url('dark',Auth::user()->id) }}" class="text-white nav-link">
            ...
            <footer
                ...
                <p class="text-muted mb-1 mb-md-0">Copyright © 2023 <a href="https://www.mmcities.com"
                        target="_blank">MMCities</a>.</p>
